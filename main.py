...
Window.clearcolor = (0.09, 0.55, 0.47, 1)
btn_color = (0.2, 0.8, 0.7, 1)
...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        instr = ScrollLabel(txt_instruction, pos_hint={'center_x': 0.5,'center_y': 0.25}, size_hint=(1, 0.5))

        lbl1 = Label(text='Введите имя:', halign='right', size_hint=(0.5, 1))
        self.in_name = TextInput(multiline=False)
        lbl2 = Label(text='Введите возраст:', halign='right', size_hint=(0.5, 1))
        self.in_age = TextInput(text='', multiline=False)
        self.btn = Button(text='Начать', size_hint=(0.3, 0.05), pos_hint={'center_x': 0.5})
        self.btn.background_color = btn_color
        self.btn.on_press = self.next

        line1 = BoxLayout(size_hint=(0.5, 0.03), height='25sp', pos_hint={'center_x': 0.5,'center_y': 0.75})
        line2 = BoxLayout(size_hint=(0.5, 0.03), height='25sp', pos_hint={'center_x': 0.5,'center_y': 0.75})
...
class Test(Screen):
    def __init__(self, **kwargs):
        ...
        line1 = ColoredLayout(lcolor = (0.15, 0.14, 0.54, 1), size_hint = (1, 0.4))
        vlay = ColoredLayout(orientation='vertical', lcolor = (0.77, 0.66, 0.18, 1), pos_hint = {'center_x': 0.5}, size_hint = (1, 0.4))
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        self.lbl_sec = Seconds(60, textcolor = '#FFFFFF')
        self.lbl_sec.bind(done=self.sec_finished)
        ...
        line2 = BoxLayout(size_hint=(0.8, None), height='30sp')
        lbl_result2 = Label(text='После отдыха:', halign='right')
        ...
        line0.add_widget(line1)
        line0.add_widget(line2)
